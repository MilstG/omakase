...
const KEY_POLICY = {
  ...
  /* pedidos de delivery del día: mismo dueño que los servicios */
  'kanjo:delivery':  { read:CORE,        write:['turnos','seki'] },
  /* liquidaciones de apps de delivery: conciliación de caja */
  'kanjo:liquidaciones': { read:CORE,    write:['caja','turnos'] },
